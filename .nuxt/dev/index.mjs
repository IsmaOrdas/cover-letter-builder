globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/node-fetch-native@1.1.0/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/std-env@3.3.2/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/h3@1.6.4/node_modules/h3/dist/index.mjs';
import { OpenAIApi, Configuration } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/openai@3.2.1/node_modules/openai/dist/index.js';
import { createRenderer } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/vue-bundle-renderer@1.0.3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/@nuxt+devalue@2.0.0/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/vue@3.2.47/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/ofetch@1.0.1/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/destr@1.2.2/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/unenv@1.3.0/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/scule@1.0.0/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/defu@6.1.2/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/ohash@1.0.0/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/ufo@1.1.1/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/unstorage@1.4.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/unstorage@1.4.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/ismx9/projects/coverletterbuilder/node_modules/.pnpm/radix3@1.0.1/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/ismx9/projects/coverletterbuilder/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ismx9/projects/coverletterbuilder","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/ismx9/projects/coverletterbuilder/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ismx9/projects/coverletterbuilder/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/ismx9/projects/coverletterbuilder/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_UjKHxx = () => Promise.resolve().then(function () { return openai$1; });
const _lazy_YK9Xv2 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/openai', handler: _lazy_UjKHxx, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_YK9Xv2, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_YK9Xv2, lazy: true, middleware: false, method: undefined }
];
...
const openai = defineEventHandler(async () => {
...
const getClientManifest = () => import('/home/ismx9/projects/coverletterbuilder/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/ismx9/projects/coverletterbuilder/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
